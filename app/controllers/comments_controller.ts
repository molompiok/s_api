...
export default class CommentsController {
    ...
    public async delete_comment({ params, request, response, auth }: HttpContext) {
        ...
        try {
            ...
            if (!isAuthor) {
                ...
                try {
                    await request.ctx?.bouncer.authorize('collaboratorAbility', [DELETE_ANY_COMMENT_PERMISSION]);
